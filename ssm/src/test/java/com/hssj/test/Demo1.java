...
//	}
	...
	public void testGoods2() {
		Link link = new Link(1, "沙发床", 1, 1);
		List<Goods> goods = goodsMapper.findByLink(link);
//		list.add(new Link(11,"布艺沙发",1,1));
//		list.add(new Link(13,"组合沙发",1,1));
		link.setLid(11);
...
//		list.add(new Link(13, "组合沙发", 1, 1));
	...
	public void testGoods4() {
		List<Goods> findCalShow = goodsMapper.findByName("汉");
		System.out.println("-------------------------------------------------");
		System.out.println("-------------------------------------------------");
